...
const MainSection = async () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="hero-rise hero-rise-1 relative z-10 w-full p-6 md:p-8 leading-[1.15]">
        {t.rich("heading", { br: () => <br />, em: chunks => <em>{chunks}</em> })}
      </h1>

      <p className="hero-rise hero-rise-2 relative z-10 max-w-[21rem] md:max-w-none text-center text-base font-normal text-foreground/70 mb-8">
