...
const Modal = ({ children }: ModalProps) => {
  ...
  useEffect(() => {
    ...
    let last = -1;
    const measure = () => {
      const maxH = window.innerHeight - (window.matchMedia("(min-width: 768px)").matches ? 96 : 24);
            ...
            <RemoveScroll removeScrollBar={false}>
              ...
              >
                <motion.div
                  ...
                  data-lenis-prevent
                  className="
                    w-[calc(100vw-1.5rem)] md:w-[calc(100vw-4rem)] md:max-w-4xl max-h-[calc(100vh-1.5rem)] md:max-h-[calc(100vh-6rem)] my-3 md:my-12 p-6 md:p-8
