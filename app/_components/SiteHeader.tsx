...
const nameNudge: Record<string, string> = {
  ...
  "zh-Hans": "-translate-y-[0.4px] md:-translate-y-[1.4px]",
  "zh-Hant": "-translate-y-[0.4px] md:-translate-y-[1.4px]",
};
    ...
    >
      ...
      <div className="flex items-center gap-2 shrink-0">
        <div className="hidden xl:flex items-center gap-3.5">
          <LanguageSwitcher />
          <ThemeToggle className="[&_svg]:[stroke-width:2.6] [&_svg]:translate-y-[0.1px] [&_svg:last-child]:w-[18.6px] [&_svg:last-child]:h-[18.6px]" />
          <ContactMenu />
        </div>
